...
// Event handlers to call calcTotal() when checkbox is clicked
...
// Function to calc the total cost of selected food items
function calcTotal() {
  let cost = 0;
...
// Increase the cost based on item selected
