...
try {
  ...
  // Check if the changeValue is less than zero (meaning the bill is greater than cash)
  if (changeValue < 0) {
      throw new Error("Cash amount doesn't cover the bill");
    }

  // If no exception is thrown, proceed with formatting and calculating the change
  ...
  // Display the error message in the "warning" element
